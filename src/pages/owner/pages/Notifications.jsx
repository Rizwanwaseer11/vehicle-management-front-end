  ...
  return (
    <div className="antialiased w-full min-h-screen bg-gray-50 dark:bg-gray-800/95 md:ml-64 pt-16 md:pt-20 px-4 md:px-6 lg:px-8 mt-4 pb-6">
      <div className="max-w-3xl mx-auto bg-white border border-default rounded-xl p-6 shadow-sm">
        <h1 className="text-2xl font-semibold text-heading">Send Notification</h1>
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-default rounded-lg px-3 py-2 text-sm h-28"
          ...
          <div>
            <label className="block text-sm font-medium text-heading mb-2">Target</label>
          ...
          {target === "roles" && (
            <div>
              <label className="block text-sm font-medium text-heading mb-2">Roles</label>
              <div className="flex flex-wrap gap-4 text-sm">
